...
const builds = [
  {
    title: "Gameplay Prototype #1",
    videoUrl: "https://www.youtube.com/embed/NizVCQeQjzo",
  },
  {
    title: "Gameplay Prototype #2",
    videoUrl: "https://www.youtube.com/embed/lcW3cdFKDdc",
  },
  {
    title: "Gameplay Prototype #3",
    videoUrl: "https://www.youtube.com/embed/9DzZKBVYcPU",
  },
];
...
const AISoloDevShowcase = () => {
  return (
    <section id="ai-solo-dev" className="py-24 relative">
      ...
      <div className="section-container relative">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground mt-4 max-w-3xl mx-auto font-body">
            End-to-end game development powered by <span className="text-secondary">Claude Code</span> and{" "}
