 ...
 *
 * IMPORTANT: do not edit this file to add your key. Only type it into the
 * terminal command below — leave every line in this file exactly as-is.
 *
 * Usage (PowerShell):
...
// The name is respelled phonetically instead of its normal spelling —
// only to coach the TTS model toward a natural pronunciation; it isn't
// spoken twice or announced as a respelling.
// Attempt 2: capitalized stress on the middle syllable, and "Sha-Heen"
// (single 'a', capital H) to stop the 'h' from disappearing into "een".
// If this still isn't right, try further variants like "Moo-DASS-ar" or
// "Shuh-Heen" and re-run.
const SCRIPT_TEXT =
  "Hey, I'm Moo-DUS-sar Sha-Heen — a Senior Unity Developer and Technical Project Manager. " +
